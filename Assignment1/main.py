from Exercise2.sample_plot import plot
from Exercise3.k_nearest_neighbors import exercise_3_question_2a_b_c, exercise_3_question_3
from Exercise4.decision_trees import gender_impurity, compare_age_impurity, gender_age_impurity, age_gender_impurity, gini_index_gender, gini_index_age, sklearn_decision_tree, entropy_gender, entropy_age, data_split_decision_trees
